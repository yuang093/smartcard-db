...
- [x] **2.3** 實作後台帳號管理頁面（登出按鈕） ✅
- [x] **2.4** API Middleware 實作 `user_id` 資料隔離 ✅

---

## Phase 3: 核心業務邏輯（名片 CRUD）

- [x] **3.1** 實作名片列表與快速搜尋列 ✅
- [x] **3.2** 實作新增名片表單 ✅
- [x] **3.3** 實作編輯名片功能 ✅
- [x] **3.4** 實作刪除名片功能 ✅
- [ ] **3.5** 實作圖片上傳 API（存放於 Docker Volume）
- [ ] **3.6** 實作前端上傳與預覽頁面
...
- [x] **4.1** 實作名片列表與快速搜尋列 ✅
- [x] **4.2** 實作手動標籤（Tags）管理介面（CRUD）✅
- [x] **4.4** 實作 Excel（`.xlsx`）批次匯出功能 ✅
- [x] **4.6** 修復 Tailwind CSS 樣式問題（顏色方塊未顯示）✅
- [x] **4.3** 實作「重複聯絡人偵測」（已簡化，暫時跳過警告視窗）✅
